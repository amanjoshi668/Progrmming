...
int main(int argc, char*argv[]){
    ...
    vector<string> a(3);
    cin>>a;
    TRV(a)reverse(all(it));
    sort(all(a));
    if(a[0] == a[1] and a[1] == a[2]){
        cout<<0<<endl;
    }
    else if((a[0][1] == a[1][1] - 1 and a[0][0] == a[1][0]) and (a[1][1] == a[2][1] - 1 and a[1][0] == a[2][0])){
        cout<<0<<endl;
    }
    else if(a[0] == a[1] or a[1] == a[2]){
        cout<<1<<endl;
    }
    else if(((a[0][1] == a[1][1] - 1 or a[0][1] == a[1][1] - 2)and a[0][0] == a[1][0]) or ((a[1][1] == a[2][1] - 1 or a[1][1] == a[2][1] - 2) and a[1][0] == a[2][0])){
        cout<<1<<endl;
    }
    else cout<<2<<endl;
    return 0;
