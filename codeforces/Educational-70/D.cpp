...
int main(int argc, char *argv[])
{
    ...
    cin>>t;
    vl prod;
    for(int i = 1; i*i<MOD; i++)prod.pb((i*(i+1))/2);
    while(t--){
        lo n;
        cin>>n;
        bool found =false;
        for(int i = prod.size() -1 ; i>=0; i--){
            ...
            if(n%it == 0){
                ...
                y++;
                lo p = 1;
                for(auto prime = y; prime > 1; prime--){
                    if(x%prime == 0){
                        p = prime;
                        break;
                    }
                }
                for(lo k = 0; k<p; k++)cout<<"1";
                for(lo k = 0; k<i+2; k++)cout<<"3";
                for(lo k = 0; k<x/p; k++)cout<<"7";
                cout<<endl;
                found = true;
                break;
            }
        ...
        if(!found){
            ...
            for(auto prime = y; prime > 1; prime--){
                if(n%prime == 0){
                    for(lo k = 0; k<prime; k++)cout<<"1";
                    cout<<"33";
                    for(lo k = 0; k<n/prime; k++)cout<<"7";
                    cout<<endl;
                    found = true;
                    break;
                }
